...
class MemoryTypeTest {
    ...
    fun parseSingleNumber_setMinToCorrectValue() {
        ...
        Truth.assertThat(memoryType.value.value.min.value).isEqualTo(expectedMin)
        Truth.assertThat(memoryType.value.value.max.value).isEqualTo(expectedMax)
    }
    ...
    fun parseNegativeMin_throwsParseExceptionWithNegativeNumberMessage() {
        val memoryType = Type.MemoryType("-123456")
        Assertions.assertThatThrownBy { memoryType.value.value.min.value }
    ...
    fun parseTwoNumbers_withMinGreaterThanMax_throwsParseExceptionWithInvalidRangeMessage() {
        ...
        Assertions.assertThatThrownBy { memoryType.value.value }
            .isInstanceOf(ParseException::class.java)
