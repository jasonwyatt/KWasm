...
class NumericConstantInstructionTest {
    ...
    fun is_calledBy_parseInstruction() {
        ...
        assertThat(instruction.valueAstNode.value).isEqualTo(16)
    }
    ...
    fun parses_i64Const() {
        ...
        assertThat(instruction.valueAstNode.value).isEqualTo(256)
    }
    ...
    fun parses_f32Const() {
        ...
        assertThat(instruction.valueAstNode.value).isEqualTo(-1.5e5f)
    }
    ...
    fun parses_f64Const() {
        ...
        assertThat(instruction.valueAstNode.value).isEqualTo(-1.5e5)
    }
